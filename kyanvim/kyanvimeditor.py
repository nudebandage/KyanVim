...
from kyvanvim.util import debug_echo
...
# class OurWidget(TextInput):
    # pass
    # def __init__(self, **kwargs):
        # super().__init__(**kwargs)
        # here = os.path.abspath(os.path.dirname(__file__))
        # print('mainloop')
        # self = Builder.load_file(os.path.join(here, 'mywidget.kv'))

class MixKivy():
    '''
    Kivy actions we bind and use to communicate to neovim
    '''
...
class KyanVimEditor(MixKivy, MixNvim):
    '''
    ...
    def start(self, bridge):
        ...
        # self.root = tk.Tk()
        # self.root.protocol('WM_DELETE_WINDOW', self._kv_quit)
...
# TODO each text editor instance should be able to connect to it's own nvim
def start_kyanvim(address=None, async=False):
    if address:
